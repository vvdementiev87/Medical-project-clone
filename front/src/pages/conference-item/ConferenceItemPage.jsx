...
import {getConferenciesUrl ,getConferenciesRegistrationUrl} from "../../config/api.config";
...
const ConferenceItemPage = () => {
    ...
    const handleSubmit = () => {
		axiosClassic.post(getConferenciesRegistrationUrl('/registration'), {
			event_id: conferenceItem?.id,
			account_id: user?.id,
		});
	};
