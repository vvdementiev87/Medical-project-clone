...
const DropdownSelect = ({
    ...
    return (
        ...
        <label className={styles.selectLabel}>
            {labelText} {custom_required?<span className="custom_required">*</span>:''}</label>
        <div className={styles.dropdownContainer}>

            <div ref={inputRef} onClick={handleInputClick} className={error?`${styles.dropdownInput} ${styles.error}`:styles.dropdownInput}>
