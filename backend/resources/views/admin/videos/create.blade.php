...
@section('content')
    ...
    <div>
        @if ($errors->any())
            ...
            @endforeach
        @endif
        <form method="post" action="{{ url(App\Classes\Helpers::getHost(true) . '/admin/videos') }}">
            @csrf
            <div class="form-group">
                <label for="video_youtube_id">Youtube ID</label>
                <input type="text" id="video_youtube_id" name="video_youtube_id" value="{{ old('video_youtube_id') }}" class="form-control @error('video_youtube_id') is-invalid @enderror">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="text_html" name="text_html" value="{{ old('text_html') }}" class="form-control @error('text_html') is-invalid @enderror">
            </div>
