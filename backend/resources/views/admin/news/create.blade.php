    ...
    <div>
        ...
        <form method="post" action="{{ route('admin.news.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="date" id="started_at" name="started_at" value="{{ old('started_at') }}" class="form-control @error('started_at') is-invalid @enderror">
            </div>
            <div class="form-group">
                <label for="ending_at">Дата снятия с публикации</label>
                <input type="date" id="ending_at" name="ending_at" value="{{ old('ending_at') }}" class="form-control @error('ending_at') is-invalid @enderror">
            </div>
            <br>
